...
func NewMqttClient(c *MqttConfig) (*MqttClientSrv, error) {
	...
	client, err := GetMqttClient(context.Background(), u)
	if err != nil {
...
func GetMqttClient(ctx context.Context, serverURL *url.URL) (*autopaho.ConnectionManager, error) {
